...
def get_plot_over_time(cell_ids, base_pressure, groove_height):
    base_dir = "data/"+sys.argv[3]+"/cases/" + groove_height + "/" + base_pressure + "/icofoam_" + groove_height + "_" + base_pressure
...
if __name__ == "__main__":
    ...
    get_plot_over_time(cell_ids, sys.argv[2], sys.argv[4])
