...
groove_height = sys.argv[2]

replace_file_name = "icofoam_" + groove_height + "_" + base_pressure
...
openfoam = OpenFOAMReader(registrationName='open.foam', FileName='/Users/amalli/Local_Storage/grooves-cfd/data/groove_height_sweep/cases/'+groove_height+'/'+ base_pressure + "/" + replace_file_name+'/open.foam')
...
# export view
ExportView('/Users/amalli/Local_Storage/grooves-cfd/data/groove_height_sweep/cases/'+groove_height+'/' +base_pressure+ '/uprofile_outlet.csv', view=spreadSheetView1, RealNumberNotation='Fixed')
