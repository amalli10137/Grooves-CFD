...
openfoam = OpenFOAMReader(registrationName='open.foam', FileName='/Users/amalli/Desktop/grooves-cfd/data/groove_height_sweep/cases/'+groove_height+'/'+ base_pressure + "/" + replace_file_name+'/open.foam')
...
# export view
ExportView('/Users/amalli/Desktop/grooves-cfd/data/groove_height_sweep/cases/'+groove_height+'/' +base_pressure+ '/uprofile_outlet.csv', view=spreadSheetView1, RealNumberNotation='Fixed')
