...
openfoam = OpenFOAMReader(registrationName='open.foam', FileName='/Users/amalli/Local_Storage/grooves-cfd/data/'+sweep+'/cases/'+base_pressure+'/'+replace_file_name+'/open.foam')
...
# export view
ExportView('/Users/amalli/Local_Storage/grooves-cfd/data/'+sweep+'/cases/'+base_pressure+'/uprofile_outlet.csv', view=spreadSheetView1, RealNumberNotation='Fixed')
